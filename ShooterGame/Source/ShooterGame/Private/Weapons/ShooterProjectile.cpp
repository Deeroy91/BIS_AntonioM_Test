...
// AntonioM BEGIN
void AShooterProjectile::InitVelocity(const FVector& ShootDirection, const FVector& EndLocation)
{
...
void AShooterProjectile::SetHandleImpact()
{
...
void AShooterProjectile::Explode(const FHitResult& Impact)
{
	...
	// AntonioM - only the server should spawn actors for them to be replicated
	if (GetLocalRole() == ROLE_Authority && ExplosionTemplate)
	{
