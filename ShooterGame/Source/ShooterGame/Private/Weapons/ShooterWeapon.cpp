...
// AntonioM BEGIN
void AShooterWeapon::SetAlternativeTargeting(bool bIsNewTargeting)
{
	if(bIsNewTargeting)
	{
		ActivateAlternativeTargeting();
	}
	else
	{
		DeactivateAlternativeTargeting();
	}
}

void AShooterWeapon::ActivateAlternativeTargeting()
{

}

void AShooterWeapon::DeactivateAlternativeTargeting()
{
